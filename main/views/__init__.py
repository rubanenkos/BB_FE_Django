...
from .request_views import blood_requests, add_request, add_request_details, search_request, approve_request
...
from .supply_views import supply, add_supply, add_supply_details, process_supply
from .donor_views import donors, add_donor

__all__ = [
    'login', 'logout', 'register', 'change_password',
    'index', 'about', 'contacts',
    'blood_requests', 'add_request', 'add_request_details', 'search_request', 'approve_request',
    'deliveries', 'create_transport',
    'users', 'user_details', 'add_user',
    'analytics',
    'supply', 'add_supply', 'add_supply_details', 'process_supply',
    'donors', 'add_donor'
]